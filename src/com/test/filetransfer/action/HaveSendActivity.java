...
* @version V1.0   
*/
public class HaveSendActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		topbar_file_tf_operate.setTitle("已发送文件");
	...
	private void initAdapter(List<Object> lo) {
		...
		mAdapter=new TransportFileAdapter(HaveSendActivity.this, mData, R.layout.file_transfer_item);
			...
			public void onLoad(Handler handler) {
				...
				try {
					resultStr = HttpClientGetOperate.httpClientGet(getBaseUrl()+
							...
							+ "&requestType=haveSend&senderId="+getCurrentUser().getUserId());
		...
		mlistview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				Intent intent=new Intent(HaveSendActivity.this, TransportFileShowActivity.class);
	...
	private void getTransportFileOfNet() {
		HttpClientAsyncGet post=new HttpClientAsyncGet(HaveSendActivity.this,new TransportFile());
		...
		if(baseURL!=null)
		{
			...
			post.setHttpClientReturnListener(new onHttpClientReturnListener() {
				...
				public void returnPostExecute(boolean isSuccess, String msg, List<Object> lo) {
					...
					{
						Toast.makeText(HaveSendActivity.this,msg, Toast.LENGTH_LONG).show();
					}
				}
			});
		}
