...
* @version V1.0   
*/
public class HaveReceiveActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		topbar_file_tf_operate.setTitle("已接收文件");
	...
	private void initAdapter(List<Object> lo) {
		...
		mAdapter=new TransportFileAdapter(HaveReceiveActivity.this, mData, R.layout.file_transfer_item);
			...
			public void onLoad(Handler handler) {
				...
				try {
					resultStr = HttpClientGetOperate.httpClientGet(getBaseUrl()+
							...
							+ "&requestType=havereceive&receiverId="+getCurrentUser().getUserId());
		...
		mlistview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				Intent intent=new Intent(HaveReceiveActivity.this, TransportFileShowActivity.class);
	...
	private void getTransportFileOfNet() {
		HttpClientAsyncGet post=new HttpClientAsyncGet(HaveReceiveActivity.this,new TransportFile());
		...
		if(baseURL!=null)
		{
			...
			post.setHttpClientReturnListener(new onHttpClientReturnListener() {
				...
				public void returnPostExecute(boolean isSuccess, String msg, List<Object> lo) {
					...
					{
						Toast.makeText(HaveReceiveActivity.this,msg, Toast.LENGTH_LONG).show();
					}
				}
			});
		}
