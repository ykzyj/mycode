...
public class SwipeAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.tv_title = (TextView)convertView.findViewById(R.id.tv_node_title);
            holder.tv_msg = (TextView)convertView.findViewById(R.id.tv_node_msg);
            holder.tv_time = (TextView)convertView.findViewById(R.id.tv_node_time);
