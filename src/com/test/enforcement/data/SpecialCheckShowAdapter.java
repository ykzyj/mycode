...
* @version V1.0   
*/
public class SpecialCheckShowAdapter extends AdapterUtil<SpecialCheck> {

	private Context mContext;

	public SpecialCheckShowAdapter(Context context, List<SpecialCheck> datas, int layoutId) {
