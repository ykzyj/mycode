 ...
 * @param <T>
*/
public class HttpClientAsyncPost extends AsyncTask<String, Long, String> {
	...
	public <T> HttpClientAsyncPost(Context context,List<File> lf,T t) {
		this.mList_file=lf;
	...
	public <T> HttpClientAsyncPost(Context context,T t) {
		this(context,null,t);
	}
	...
	protected String doInBackground(String... params) {
		...
		String resultStr="";
		try {
			resultStr=HttpClientPostOperate.httpClientPost(params[0], mO, mList_file,mlistener);
